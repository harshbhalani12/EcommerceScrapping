...
<html>
    ...
    <body>
        ...
        <div class="main">
            <div class="shop_top">
                <div class="container">
                    <form action="RegisterServiceProviderServlet"> 
                        <div class="register-top-grid">
                            ...
                            <div>
                                <span>Product Category<label>*</label></span>
                                <select class="selectpicker form-control" name="productCategory">
                            ...
                            <div>
                                <span>Experiance<label>*</label></span>
