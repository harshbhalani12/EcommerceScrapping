 ...
 * @author Admin
 */
public class TotalUsersShow extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ArrayList<Register> ar=new ArrayList<>();
            ...
            RequestDispatcher rd = request.getRequestDispatcher("TotalUsers.jsp");
