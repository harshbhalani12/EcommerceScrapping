<%-- 
    Document   : TotalServiceProvider
    Created on : 13 May, 2017, 10:48:15 PM
    Author     : Admin
--%>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Total Service Provider</h3>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <%
                                            if (request.getAttribute("RegisterAL") != null) {
                                                ArrayList<RegisterServiceProvider> al2 = (ArrayList<RegisterServiceProvider>) request.getAttribute("RegisterAL");
                                                for (int j = 0; j < al2.size(); j++) {
                                                    RegisterServiceProvider r = al2.get(j);
                                        %>
                                    <tr>
                                        <td><%=r.getFirstName()%></td>
                                        <td><%=r.getLoginId().getEmail()%></td>
                                        <td><a href="viewServiceProviderServlet1?id=<%=r.getLoginId().getLoginId()%>" class="btn-info" style="text-decoration: none; padding:5px; border-radius: 5px;">
                                                View
                                            </a>
                                        </td>
                                    </tr>
