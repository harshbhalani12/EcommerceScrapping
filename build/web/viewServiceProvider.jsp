                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <%
                                        if(request.getAttribute("al")!=null){
                                            ...
                                            //ArrayList<Register> al1 = (ArrayList<Register>)request.getAttribute("al1");
                                            for(int i=0;i<al.size();i++){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>pending..</td>
                                                    <td><a href="viewServiceProvider?id=<%=l.getLoginId()%>" class="btn-info" style="text-decoration: none; padding:5px; border-radius: 5px;">View
                                                        <a href="updateServiceProviderStatus?id=<%=l.getLoginId()%>" class="btn-danger" style="text-decoration: none; padding:5px; border-radius: 5px; margin-left: 10px;">Accept</td>
                                                    </td>
                                                </tr>
                                                <%
                                            }
